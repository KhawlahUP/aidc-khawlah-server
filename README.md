...
Given a 16 GB budget, 4 concurrent users, and a 4096-token context, the largest model that fits is Llama-3.2-3B-Instruct at fp16 (9.80 GB total). All 15 model/precision combinations in the catalog fit this scenario.

Files: generate.py, results.json, budget_solution.json
